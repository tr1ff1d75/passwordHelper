...
public class DetailsActivity extends AppCompatActivity {
    TextView site_name,site_login,site_pass;
    PasswordDatabase db;
    EditText password;
    Button modify;
    Button showPassword;
    String getPass,getLgn,s;
    String newPassword, newLogin,pass;
    int getUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        site_login=(TextView)findViewById(R.id.displaySiteLoginId);
        ...
        getLgn=getIntent().getStringExtra("Login");
        pass=db.getData(s);
        site_name.setText(s);
        site_login.setText(getLgn);
        site_pass.setText("**********");
        ...
        showPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog b=dialogBuilder.create();
                b.getWindow().getAttributes().windowAnimations = R.anim.bottom_in;
                b.show();
            }
        });
    }
