package com.belstu.gulko.passwordHelper.database;
...
import com.belstu.gulko.passwordHelper.activity.SplashActivity;
...
public final class PasswordDatabase extends SQLiteOpenHelper {
    ...
    public static final String GET_EMAIL = SplashActivity.sh.getString("email", null);
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = GET_EMAIL + "User.db";
    public static final String TABLE_NAME = "PasswordHelperBase";
    ...
    private static final String TABLE_CREATE = "CREATE TABLE "
            + TABLE_NAME + " (" +  COLUMN_ACCOUNT  + " TEXT, "+  COLUMN_LOGIN  + " TEXT, " + COLUMN_PASSWORD
    ...
    public void addCredentials(Context context,String account, String login, String password){
    ...
    public void modify(String account,String login,String pass){
        SQLiteDatabase db=this.getWritableDatabase();
    ...
    public List<String> getLogins(){
        ...
        Cursor c=null;
        try{
            String query="SELECT " + COLUMN_LOGIN + " FROM " + TABLE_NAME;
            c=db.rawQuery(query,null);
            if(c!=null){
                if(c.moveToFirst()){
                    do{
                        logins=c.getString(c.getColumnIndex(COLUMN_LOGIN));
                        collection.add(logins);
                    }
                    while (c.moveToNext());
                }
            }
